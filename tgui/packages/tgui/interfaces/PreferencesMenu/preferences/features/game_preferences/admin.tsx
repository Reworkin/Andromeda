...
export const asaycolor: Feature<string> = {
  ...
  category: 'Админ',
  description: 'Цвет ваших сообщений в Asay.',
...
export const bypass_deadmin_in_centcom: FeatureToggle = {
  name: 'Игнорировать деадмин при спавне на ЦК',
  category: 'Админ',
  description:
...
export const auto_deadmin_on_ready_or_latejoin: FeatureToggle = {
  name: 'Авто деадмин - При готовности или позднем присоединении',
  category: 'Админ',
  description: `
    При включении вы автоматически становитесь деадмином, когда нажимаете "Готов" или
    присоединяетесь к уже начавшемуся раунду.
  `,
  component: CheckboxInput,
};
