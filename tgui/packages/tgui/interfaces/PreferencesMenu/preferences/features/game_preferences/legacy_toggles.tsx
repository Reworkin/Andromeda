...
export const combohud_lighting: FeatureToggle = {
  name: 'Включить Боевой-HUD с полным светом',
  category: 'Админ',
  component: CheckboxInput,
};
...
export const deadmin_always: FeatureToggle = {
  name: 'Авто деадмин',
  category: 'Админ',
  description: 'Автоматический деадмин при заходе в раунд.',
  component: CheckboxInput,
};
...
export const deadmin_antagonist: FeatureToggle = {
  ...
  category: 'Админ',
  description: 'Автоматический деадмин, если вы антагонист.',
  component: CheckboxInput,
};

export const deadmin_position_head: FeatureToggle = {
  name: 'Авто деадмин - глава отдела',
  category: 'Админ',
  description:
    'Автоматический деадмин, если вы становитесь главой какого-либо отдела',
  component: CheckboxInput,
};

export const deadmin_position_security: FeatureToggle = {
  name: 'Авто деадмин - СБ',
  category: 'Админ',
  description:
    'Автоматический деадмин, если вы становитесь членом службы безопасности.',
  component: CheckboxInput,
};

export const deadmin_position_silicon: FeatureToggle = {
  name: 'Авто деадмин - синтетик',
  category: 'Админ',
  description: 'Автоматический деадмин, если вы синтетик.',
  component: CheckboxInput,
};
