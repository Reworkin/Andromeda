/datum/quirk/light_step
	name = "Light Step"
	desc = "(Мягкий шаг) - Вы ходите мягким шагом, наступание на острые предметы будут тише и менее болезненными. Кроме того, вы не испачкаете руки и одежду, если наступите в кровь."
