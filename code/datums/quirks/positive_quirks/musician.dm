/datum/quirk/item_quirk/musician
	name = "Musician"
	desc = "(Музыкант) - Вы можете настраивать ручные музыкальные инструменты, чтобы играть мелодии, которые устраняют некоторые негативные эффекты и успокаивают душу."
	icon = FA_ICON_GUITAR
	value = 2
