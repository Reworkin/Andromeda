/datum/quirk/indebted
	name = "Indebted"
	desc = "(Задолжавший) - Неудачные жизненные решения, медицинские счета, студенческие кредиты, подписка на wetskr... - что бы это ни было, вы имеете хвост из долгов. Часть всего, что вы получаете, пойдет на его погашение."
	icon = FA_ICON_DOLLAR
