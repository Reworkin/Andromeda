/datum/quirk/unstable
	name = "Unstable"
	desc = "(Нестабильный) - Из-за прошлых неприятностей вы не сможете восстановить рассудок, если потеряете его. Будьте очень осторожны в управлении своим настроением!"
	icon = FA_ICON_ANGRY
	value = -10
