/datum/quirk/clumsy
	name = "Clumsy"
	desc = "(Неуклюжесть) - Ты неуклюжий, глупый чувак. Ты большой и всеми любимый недотепа! Надеюсь, ты не собирался использовать свои руки для чего-либо, требующего хоть малейшей ловкости рук."
