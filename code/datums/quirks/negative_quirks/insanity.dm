/datum/quirk/insanity
	...
	desc = "(Синдром диссоциации реальности) - Вы страдаете от тяжелого расстройства, которое вызывает очень яркие галлюцинации. \
		Токсин Разрушителя Разума подавляет воздействие этого недуга, и у вас так же выработался иммунитет к галлюциногенным свойствам токсина. \
