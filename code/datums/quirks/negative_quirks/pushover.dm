/datum/quirk/pushover
	name = "Pushover"
	desc = "(Ведомый) - Ваше мышление заключается в том, чтобы всегда позволять людям манипулировать вами и делать из вас ведомого. Сопротивление из захвата потребует особых усилий."
