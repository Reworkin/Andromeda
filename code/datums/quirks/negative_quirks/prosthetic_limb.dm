/datum/quirk/prosthetic_limb
	...
	desc = "(Протез конечности) - В результате несчастного случая вы потеряли одну из своих конечностей. Из-за этого у вас установлен дешевый протез!"
