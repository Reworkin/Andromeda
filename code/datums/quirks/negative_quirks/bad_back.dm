/datum/quirk/badback
	name = "Bad Back"
	desc = "(Больная спина) - Из-за вашей плохой осанки рюкзаки и другие сумки никогда не сидят правильно на вашей спине. Более равномерно распределённые предметы подходят нормально."
	icon = FA_ICON_HIKING
	value = -8
