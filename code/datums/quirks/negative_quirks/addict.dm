/datum/quirk/item_quirk/addict
	name = "Addict"
	desc = "(Зависимый) - Вы зависимы от того, чего не существует. Страдайте."
...
/datum/quirk/item_quirk/addict/junkie
	name = "Junkie"
	desc = "(Наркоман) - Вы не можете перестать употреблять тяжелые наркотики."
	icon = FA_ICON_PILLS
	value = -6
...
/datum/quirk/item_quirk/addict/smoker
	name = "Smoker"
	desc = "(Курильщик) - Иногда вам очень хочется закурить. Возможно, это не очень полезно для ваших легких."
...
/datum/quirk/item_quirk/addict/alcoholic
	name = "Alcoholic"
	desc = "(Алкоголик) - Вы просто не можете жить без алкоголя. Ваша печень - это машина, которая превращает этанол в ацетальдегид."
