/datum/quirk/item_quirk/scarred_eye
	name = "Scarred Eye"
	desc = "(Одноглазый) - Происшествие в вашем прошлом стоило вам одного глаза, но вы получили крутую повязку. Йо-хо-хо!"
	icon = FA_ICON_EYE_SLASH
	value = -2
	gain_text = span_danger("Спустя всё это время ваш глаз всё ещё немного ноет...")
	lose_text = span_notice("Ваше периферическое зрение увеличилось примерно на тридцать процентов.")
	medical_record_text = "У пациента серьёзные шрамы на одном из глаз, приводящие к частичной потере зрения."
	hardcore_value = 2
