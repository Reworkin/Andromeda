...
/datum/quirk/transhumanist
	name = "Transhumanist"
	desc = "(Трансгуманист) - Вы считаете синтетическую форму жизни идеальной и презираете органическую плоть. Вы радуетесь рядом с синтетиками и расстраиваетесь, когда рядом с вами органические формы жизни и нет никого хоть как-то смахивающего на киборга. Вы стремитесь заменить свои мясистые конечности на их хромированные аналоги. Вы начинаете с роботизированной конечностью."
	icon = FA_ICON_ROBOT
