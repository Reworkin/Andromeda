/datum/quirk/pineapple_hater
	...
	desc = "(Хейтер ананасов) - Вы испытываете сильное отвращение к ананасам. Серьезно, как, черт возьми, кто-то может говорить, что они вкусные? И какой безумец вообще осмелится положить их на пиццу!?"
