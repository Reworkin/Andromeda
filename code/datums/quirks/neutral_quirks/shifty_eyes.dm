/datum/quirk/shifty_eyes
	name = "Shifty Eyes"
	desc = "(Бегающие глаза) - Ваши глаза склонны блуждать по сторонам, независимо от того, хотите вы этого или нет, из-за чего люди иногда думают, что вы смотрите прямо на них, хотя это не так."
	icon = FA_ICON_EYE
	value = 0
