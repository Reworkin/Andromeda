/datum/personality/introvert
	...
	name = "Интроверт"
	desc = "Я предпочитаю быть один, читая или рисуя в библиотеке."
	pos_gameplay_desc = "Любит находиться в библиотеке"
	// neg_gameplay_desc = "Не любит большие группы"
...
/datum/personality/extrovert
	...
	name = "Экстраверт"
	desc = "Я предпочитаю быть окружённым людьми, выпивая в баре."
	pos_gameplay_desc = "Любит находиться в баре"
	// neg_gameplay_desc = "Не любит одиночество"
...
/datum/personality/paranoid
	...
	name = "Параноидальный"
	desc = "Все и всё вокруг хотят меня достать! Это место - смертельная ловушка!"
	pos_gameplay_desc = "Любит быть один или в небольших группах"
	neg_gameplay_desc = "Испытывает стресс при нахождении с одним другим человеком или в больших группах"
	processes = TRUE
