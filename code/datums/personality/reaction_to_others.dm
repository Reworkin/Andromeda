/datum/personality/callous
	...
	name = "Бессердечный"
	desc = "Меня мало волнует, что происходит с другими людьми."
...
/datum/personality/empathetic
	...
	name = "Эмпатичный" // согласно гуглу "empathic" означает понимание других людей, а "empathetic" - чувствование того, что чувствуют они
...
/datum/personality/aloof
	savefile_key = "aloof"
	name = "Отстранённый"
	desc = "Почему все такие чувствительные? Я предпочитаю, чтобы меня оставили в покое."
...
/// Вызывает негативное настроение у нашего владельца особенности по сигналу
