...
/// Имя для резервного человека, когда нелюди становятся главой персонала
/datum/preference/name/backup_human
	explanation = "Имя резервного человека"
	group = "backup_human"
...
/datum/preference/name/operative_alias
	...
	explanation = "Оперативник псевдоним"
	group = "antagonists"
