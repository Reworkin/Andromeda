...
#define BODYPART_ICON_SHADEKIN 'icons/bodyparts/shadekin_parts_greyscale.dmi'
...
// HowlingVoid shadekin bodyparts integration.
// SHADEKIN //
#define BODYPART_ICON_SHADEKIN 'icons/bodyparts/shadekin_hv_parts_greyscale.dmi'
...
/obj/item/bodypart/head/shadekin
	...
	brute_modifier = 1.2
	burn_modifier = 1.2
	eyes_icon = 'icons/shadekin/shadekin_hv_eyes.dmi'
